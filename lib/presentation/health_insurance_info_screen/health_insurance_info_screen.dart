...
class HealthInsuranceInfoScreen extends StatelessWidget {
  HealthInsuranceInfoScreen({Key? key}) : super(key: key);
  ...
  //   Navigator.pushNamed(context, AppRoutes.healthConfirmationScreen);
  // }
  onTapContinue(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) =>
              HealthConfirmationScreen(cardNumberController.text.toString())),
    );
  }
}
