    ...
    if (number_controller.text.isEmpty ||
      ...
      if (cid != null) {
        var response = await http.post(
          ...
          body: jsonEncode({"event": "loan_payment", "scheme": "education"}),
        );

        if (response.statusCode == 200) {
          Navigator.pushNamed(context, AppRoutes.educationLoanReciptScreen);
        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarSubtitle2(
                    text: "Password", margin: EdgeInsets.only(left: 83.h)),
                actions: [
                  AppbarImage1(
