...
class CarLoanPaymentScreen extends StatelessWidget {
  var amt;
  CarLoanPaymentScreen(this.amt, {Key? key}) : super(key: key);
  ...
  //   Navigator.pushNamed(context, AppRoutes.carLoanPasswordPageScreen);
  // }
  onTapContinue(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => CarLoanPasswordPageScreen(amt)),
    );
  }
}
