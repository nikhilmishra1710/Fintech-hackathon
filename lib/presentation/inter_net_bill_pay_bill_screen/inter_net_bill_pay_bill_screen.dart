...
class InterNetBillPayBillScreen extends StatelessWidget {
  InterNetBillPayBillScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Container(
                      width: 294.h,
                      margin:
                          EdgeInsets.only(left: 36.h, top: 12.v, right: 36.h),
                      child: Text(
  ...
  onTapPaynow(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.interNetBillPasswordScreen);
  }
}
