...
class EidTransferConfirmationScreen extends StatelessWidget {
  var name, accNo, amt;
  EidTransferConfirmationScreen(this.name, this.accNo, this.amt, {Key? key})
      : super(key: key);
  ...
  //   Navigator.pushNamed(
  //       context, AppRoutes.eidGiftCardTransferConfirmationScreen);
  // }
  onTapContinue(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) =>
              EidGiftCardTransferConfirmationScreen(name, accNo, amt)),
    );
  }
}
