import '../fd_payment_screen/widgets/investmentamoun_item_widget.dart';
...
class FdPaymentScreen extends StatelessWidget {
  FdPaymentScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            appBar: CustomAppBar(
                ...
                title: Padding(
                  ...
                  child: AppbarSubtitle2(text: "Pre - Confirmation"),
                ),
                actions: [
                  AppbarImage1(
                      ...
                      Expanded(
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return InvestmentamounItemWidget();
                              })),
                      Padding(
  ...
  onTapSubmit(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.passwordForFdScreen);
  }
}
