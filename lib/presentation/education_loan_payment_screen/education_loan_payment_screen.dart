...
class EducationLoanPaymentScreen extends StatelessWidget {
  var amt;
  EducationLoanPaymentScreen(this.amt, {Key? key}) : super(key: key);
  ...
  //   Navigator.pushNamed(
  //       context, AppRoutes.educationLoadEducationLoanPasswordPaymentPageScreen);
  // }
  onTapContinue(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) =>
              EducationLoadEducationLoanPasswordPaymentPageScreen(amt)),
    );
  }
}
