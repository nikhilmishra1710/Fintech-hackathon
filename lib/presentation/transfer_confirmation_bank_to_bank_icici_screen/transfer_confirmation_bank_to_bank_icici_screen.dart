...
class TransferConfirmationBankToBankIciciScreen extends StatelessWidget {
  var name, accNo, amt;
  TransferConfirmationBankToBankIciciScreen(this.name, this.accNo, this.amt,
      {Key? key})
      : super(key: key);
  ...
  onTapSend(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.bankToBankConfirmationSuccessfulTransferIciciScreen);
  }
}
